...
* Pairing with the number of productions will make the analysis more convincing, as the higer the production, the more likely for good movies to be created.
